...
class NetworkEngine:
    ...
    def set_arpanet_topology(self):
        ...
        self.graph_topology = pickle.load(open("c:/Users/Utilizador/Ambiente de Trabalho/Tese/RRC_DRL_Update/RRC_DRL_Updates/TopologyFiles/topology_arpanet.pickle", "rb"))
        ...
        self.all_tms = json.load(open("c:/Users/Utilizador/Ambiente de Trabalho/Tese/RRC_DRL_Update/RRC_DRL_Updates/TrafficMatrix/tms_arpanet_train.json", mode="r"))
        self.current_index = 0
        self.current_tm_index = self.current_index % len(self.all_tms)       
        self.communication_sequences = self.all_tms[self.current_tm_index]
